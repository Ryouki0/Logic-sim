...
// export function deepCopyGate(gate: Gate): Gate {
...
// export function deepCopyNestedGates(gates: {[key: string]: Gate}){
...
// export function deepCopyInputs(inputs: {[key: string]: BinaryInput}){
...
// export function deepCopyOutputs(outputs:{[key: string]: BinaryOutput}){
